    ...
    def execute(self, context):
        ...
        for parent in dictchild:
            ...
            if createSkin:
                ...
                print("creating stand in planes")
                ...
                for merge in mergeOrders:
                    if merge.child.isMesh:
                        ...
                        bpy.ops.mesh.primitive_plane_add(size=selected.dimensions[0], enter_editmode=False, align='WORLD', location=(locationNew[0], locationNew[1], locationNew[2]), scale=(1, 1, 1))
